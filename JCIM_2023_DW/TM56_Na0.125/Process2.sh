...
#vmd ../input/ionized.psf output_wrapped.dcd -dispdev text -e /home/wud18/vmd/VMDScripts/Analysis/Wrap.tcl -args -atomsel protein_or_nucleic -outfile output_wrapped_TM56.dcd > wrap.log
...
python /home/wud18/python/align.py -s ../input/ionized.pdb -t output_wrapped_TM56.dcd -sel protein -o output_wrapped_TM56_aligned.dcd > align_TM56.log 
...
mdconvert -o output_wrapped_TM56.xtc output_wrapped_TM56.dcd && rm output_wrapped_TM56.dcd

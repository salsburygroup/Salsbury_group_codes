...
class WKMeans(object):
    ...
    def __wk_means(self, data, k, beta, centroids=None, weights=None, max_ite=10000000, distance='SqEuclidean', p=None):
    ...
    def wk_means(self, data, k, beta, init_centroids=None, init_weights=None, distance='SqEuclidean', replicates=1, p=None, max_ite=10000000):
        #Weighted K-Means

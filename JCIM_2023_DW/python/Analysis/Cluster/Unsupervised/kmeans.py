...
class KMeans(object):
    ...
    def k_means(self, data, k, replicates=1, init_centroids=None, dist='SqEuclidean', p=None, max_ite=1000000):
    ...
    def __k_means_batch(self, data, k, centroids=None, distance='SqEuclidean', p=None, max_ite=10000000):

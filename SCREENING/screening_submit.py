...
def submit_jobs(screen_type):
    ...
    # calculate the ceiling integer of library_size / 10000
    num_jobs = math.ceil(library_size / 10000)

    # loop over the range and submit the jobs
    for n in range(1, num_jobs+1):
        os.system(f'sbatch --export=n={n},m=10000 docking_{screen_type}.slurm')
